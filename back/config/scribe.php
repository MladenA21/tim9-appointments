...
return [
    ...
    'base_url' => 'https://tim9.smetkovodstvo.com',
    ...
    'auth' => [
        ...
        'extra_info' => '<aside>***Important**** <br> Insertion of this Bearer token is done by our backend. When submitting a request the cookie is automatically attached to the request as a bearer token.</aside>',
    ],
